    ...
    return (
        <>
            <div id="card-persona">
                ...
                <Row>
                    <Col>
                        <span className="left bottom">Github: <a href={contato} target="_blank" rel="noreferrer"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
